...
const Features = () => {
    return (
        <section className={styles.sav_Features}>
            <div className={styles.sav_FeaturesHeader}>
                <div className={styles.sav_Badge}>Savique Intelligence</div>
                <h2>The <span>Wealth Engine</span></h2>
                <p>Designed to automate the tedious parts of finance so you can focus on growth.</p>
            </div>

            <div className={styles.sav_FeaturesGrid}>
                {/* 1. Unified Assets */}
                <div className={styles.sav_FeatureCard}>
                    <div className={styles.sav_IconBox}><LayoutGrid size={28} /></div>
                    <h3>Unified Assets</h3>
                    <p>Connect banks, investments, and crypto. See your entire net worth in one beautiful dashboard.</p>
                </div>
                {/* 2. Automated Budget */}
                <div className={styles.sav_FeatureCard}>
                    <div className={styles.sav_IconBox}><Wallet size={28} /></div>
                ...
                <div className={styles.sav_FeatureCard}>
                    <div className={styles.sav_IconBox}><Zap size={28} /></div>
                    <h3>Predictive Insights</h3>
                    <p>AI that forecasts your cash flow and alerts you before you overspend or miss a bill.</p>
                </div>
                {/* 4. Investment Growth */}
                <div className={styles.sav_FeatureCard}>
                    <div className={styles.sav_IconBox}><LineChart size={28} /></div>
                ...
                <div className={styles.sav_FeatureCard}>
                    <div className={styles.sav_IconBox}><ShieldCheck size={28} /></div>
